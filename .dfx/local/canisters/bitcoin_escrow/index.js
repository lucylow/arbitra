...
import { idlFactory } from './bitcoin_escrow.did.js';
export { idlFactory } from './bitcoin_escrow.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BITCOIN_ESCROW;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bitcoin_escrow.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bitcoin_escrow canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bitcoin_escrow.did.js")._SERVICE>}
 */
export const bitcoin_escrow = createActor(canisterId);
