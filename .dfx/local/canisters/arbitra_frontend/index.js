...
import { idlFactory } from './arbitra_frontend.did.js';
export { idlFactory } from './arbitra_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ARBITRA_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./arbitra_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the arbitra_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./arbitra_frontend.did.js")._SERVICE>}
 */
export const arbitra_frontend = createActor(canisterId);
