...
import { idlFactory } from './ai_analysis.did.js';
export { idlFactory } from './ai_analysis.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AI_ANALYSIS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ai_analysis.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ai_analysis canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ai_analysis.did.js")._SERVICE>}
 */
export const ai_analysis = createActor(canisterId);
