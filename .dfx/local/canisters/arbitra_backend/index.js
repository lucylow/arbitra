...
import { idlFactory } from './arbitra_backend.did.js';
export { idlFactory } from './arbitra_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ARBITRA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./arbitra_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the arbitra_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./arbitra_backend.did.js")._SERVICE>}
 */
export const arbitra_backend = createActor(canisterId);
