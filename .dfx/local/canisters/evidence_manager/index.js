...
import { idlFactory } from './evidence_manager.did.js';
export { idlFactory } from './evidence_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EVIDENCE_MANAGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./evidence_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the evidence_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./evidence_manager.did.js")._SERVICE>}
 */
export const evidence_manager = createActor(canisterId);
